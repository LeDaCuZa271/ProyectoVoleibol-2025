...
public class VentanaRegRecinto extends JFrame {
	...
	public VentanaRegRecinto() {
		...
		JLabel lblTitulo = new JLabel("Registro de Recinto");
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"La Paz", "Santa Cruz", "El Alto", "Chuquisaca", "Beni", "Pando", "Oruro", "Cochabamba", "Tarija", "Potosi"}));
		comboBox.setToolTipText("");
		comboBox.setMaximumRowCount(10);
		comboBox.setBounds(133, 67, 261, 31);
		panFormulario.add(comboBox);
	}
}
